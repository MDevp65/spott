...
import { Calendar, Eye, MapPin, QrCode, Trash, Users, X } from 'lucide-react'
...
const EventCard = ({
    ...
    if (variant === "list") {
        return (
            <Card className={`py-0 group cursor-pointer hover:shadow-lg transition-all hover:border-purple-500/50 ${className}`}
                onClick={onClick}
            >
                    ...
                    <div className='w-20 h-20 rounded-lg shrink-0 overflow-hidden relative'>
                        {
                            event.coverImage ? (
                                ...
                                <div className="absolute inset-0 flex items-center justify-center text-3xl" style={{ backgroundColor: event.themeColor }}>
        ...
        >
            <div className='relative overflow-hidden h-48'>
                {
                    event.coverImage ? (
                        ...
                        <div className="w-full h-full flex items-center justify-center text-4xl" style={{ backgroundColor: event.themeColor }}>
                            {getCategoryIcon(event.category)}
                        </div>
                    )
                }
            ...
            <CardContent className={"space-y-3"}>
                <div className="">
                    ...
                    <h3 className="font-semibold text-lg line-clapm-2 group-hover:text-purple-400 transition-colors">
                        {event.title}
                    </h3>
                </div>
