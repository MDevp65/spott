...
const EventPage = () => {
    ...
    const { data: event, isLoading: isEventLoading } = useConvexQuery(api.events.getEventBySlug, {
        slug: params?.slug
    })

    const { data: registration } = useConvexQuery(api.registration.checkRegistration, event?._id ? { eventId: event._id } : "skip");
    ...
    return (
        <div style={{
            ...
            <div className="max-w-7xl mx-auto px-8">
                ...
                {
                    event?.coverImage && (
                        <div className="relative rounded-2xl overflow-hidden mb-6 h-[250px] md:h-[400px]">
                            <Image
