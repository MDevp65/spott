...
export const registerForEvent = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // Check if event full
    if (event.registrationCount >= event.capacity) throw new Error("Event is full!");

    const exitingRegistration = await ctx.db
      .query("registrations")
    ...
    if (exitingRegistration) throw new Error("You have already registered for this event!");
